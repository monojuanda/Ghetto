 ...
 * @author Tamayo B
 */
public class ActualizarInvM extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String update = "UPDATE Invmujer SET categoria = '"+ Cate +"'," + "color = '" + Colo + "', " + "descripcion = '" + Desc + "', " + "precio = '" + Pre + "', " + "coleccion = '" + Colec + "', " + "cantidad = '" + Cant + "'" + "WHERE id = '" + id + "';";
