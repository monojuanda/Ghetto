...
public class ActualizarCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String t = request.getParameter("tip");
        ...
        try{
            ...
            String update = "UPDATE Clientes SET nombres = '"+ nom +"'," + "apellidos = '" + ape + "', " + "tipo = '" + t + "', " + "identificacion = '" + num + "', " + "telefono = '" + tel + "', " + "departamento = '" + depar + "', " + "ciudad = '" + ciud + "'" + "WHERE id = '" + id + "';";
