<%-- 
    Document   : ListarInventariosH
    Created on : 13/11/2018, 07:29:30 PM
    Author     : Tamayo B
--%>
    ...
    <body class="fondo1">
        ...
        %>
         <div class="container cont-table">
            <h2 class="myh2">Listar inventario de Hombre</h2>
            <table id="table_id" class="table table-hover mytable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><%=Invh.getItem()%></td>
                        <td><%=Invh.getCategoria()%></td>
                        <td><%=Invh.getDescripcion()%></td>                        
                        <td><%=Invh.getCantidad()%></td>
                        <td>
                            <a class="btn btn-wh btn-sm" data-toggle="modal" data-target="#myModal" onclick="ver('<%= Invh.getColor()%>', '<%= Invh.getGenero()%>', '<%= Invh.getPrecio()%>', '<%= Invh.getColeccion()%>')"><span class="far fa-eye" aria-hidden="true"></span></a>
                            <a class="btn btn-bl btn-sm" data-toggle="modal" data-target="#myModal10" onclick="Mostrar(<%= Invh.getId()%>, '<%= Invh.getCategoria()%>', '<%= Invh.getColor()%>', '<%= Invh.getDescripcion()%>', '<%= Invh.getPrecio()%>', '<%= Invh.getColeccion()%>', '<%= Invh.getCantidad()%>')"><span class="fas fa-edit h" aria-hidden="true"></span></a>
